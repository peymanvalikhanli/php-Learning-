...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2023 at 12:22 PM
...
INSERT INTO `actions` (`id`, `name`, `actionDescription`, `product`, `createdBy`, `creationDate`, `modifyDate`) VALUES
(1, '*', 'all action of the system ', 'IAMI', 'system', '2023-06-03 11:17:13', '2023-06-03 16:37:00'),
(2, 'login', '', 'IAMI', 'system', '2023-06-03 11:07:10', '2023-06-03 16:37:13'),
(3, 'restet password', '', 'IAMI', 'system', '2023-06-03 11:07:28', '2023-06-03 16:37:15'),
(4, 'get otp', '', 'IAMI', 'system', '2023-06-03 11:10:15', '2023-06-03 16:37:17'),
(5, 'get capcha', '', 'IAMI', 'system', '2023-06-03 11:10:29', '2023-06-03 16:37:19'),
(6, 'get mail verify', '', 'IAMI', 'system', '2023-06-03 11:11:09', '2023-06-03 16:37:20'),
(7, 'register', 'all user must register system ', 'IAMI', 'system', '2023-06-03 11:06:53', '2023-06-03 16:37:22');
...
INSERT INTO `products` (`name`, `createdBy`, `creationDate`, `modifyDate`) VALUES
('IAMI', 'system', '2023-06-03 16:35:50', '2023-06-03 16:35:50');
...
CREATE TABLE `users` (
  ...
  `otpStatusID` int(11) NOT NULL DEFAULT 1,
...
('peyman', NULL, 'test', 'test1', 'test@test.com', 0, '09123456789', 0, '123456789', NULL, NULL, 0, NULL, NULL, 1, 'system', '2023-06-10 08:49:17', '2023-06-10 08:49:17'),
('test12', NULL, 'test2', 'test12', 'test11@test.com', 0, '09321456789', 0, '123456789', NULL, NULL, 1, NULL, NULL, 1, 'system', '2023-06-10 08:52:06', '2023-06-10 08:57:22'),
('test67', '123', 'test', '67', 'test67@test.com', 1, '98567452', 1, '123123', 0, '', 1, '', '0000-00-00 00:00:00', 1, 'php code', '2023-06-10 09:23:33', '2023-06-10 09:23:33');
